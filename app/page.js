      ...
      <>
          ...
          <div className="bg-black mt-screen py-12 h-screen flex flex-col justify-between">
              ...
              <h2 className="text-center text-white text-3xl">
                  We facilitate the{" "}
                  <i>selection, design, and implementation</i> of strategic
                  projects.
              </h2>
          </div>
          ...
          <Testimonials />
          <FullCta />
          <Info background="#efeee8" title="SERVICES" sections={servicesSection} textLight={false} />
          <ResourcesPreviewList />
          <Info background="#efeee8" title="PARTNERS" sections={partnerSections} textLight={false} />
      </>
  );
}
